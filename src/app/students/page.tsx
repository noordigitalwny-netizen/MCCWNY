        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
          ...
          <div className="flex items-center gap-2 text-xs w-full sm:w-auto">
            ...
            <select
              ...
              className="w-full sm:w-auto px-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-semibold text-slate-900 dark:text-white focus:ring-2 focus:ring-purple-500"
            >
            ...
            <div className="max-w-xs mx-auto">
              ...
              <p className="text-xs text-slate-500 mt-1">
                {searchTerm || genderFilter !== "all"
                  ? "No student matching your search or gender filter was found."
